...
COPY faculties
FROM '/home/lesley/Project-1/faculties.csv'
DELIMITER ','
CSV HEADER;

COPY programs
FROM '/home/lesley/Project-1/programs.csv'
DELIMITER ','
CSV HEADER;

COPY instructors
FROM '/home/lesley/Project-1/instructors.csv'
DELIMITER ','
CSV HEADER;

COPY courses
FROM '/home/lesley/Project-1/courses.csv'
DELIMITER ','
CSV HEADER;

COPY pre_requisties
FROM '/home/lesley/Project-1/pre_reqs.csv'
DELIMITER ','
CSV HEADER;

COPY courses_programs
FROM '/home/lesley/Project-1/courses_programs.csv'
DELIMITER ','
CSV HEADER;
